...
/*  The  minimal IMU-Joystick template file.
    For runnable examples demos check out the /examples/ directory. */

// Initialize Joystick with 2 buttons and 2 axes (X,Y)
Joystick_ Joystick(JOYSTICK_DEFAULT_REPORT_ID,
    JOYSTICK_TYPE_MULTI_AXIS, 2, 0, true, true, false,
...
void loop() {
    ...
    //if (digitalRead(ProxSensor)  //proximity sensor as game controller button
    digitalRead(ProxSensor);
    ...
    if (mpuIntStatus & 0x02) {
        ...
        /////////////////////////////////////////////
        // send custom joystick behavior
        // based on acceleration & gyro data here.
        // ...
        //
        ////////////////////////////////////////////
